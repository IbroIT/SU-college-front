    ...
    <div>
      ...
      <div>
        ...
        <Link to={`/documents/70`}>
          <p>Положение «О системе менеджмента качества образования Учреждения «Салымбеков Университет»</p>
        </Link>
        <Link to={`/documents/71`}>
          <p>Положение IT</p>
        </Link>
        <Link to={`/documents/72`}>
          <p>Положение о взаимодействии структурных подразделений со стейкхолдерами СУ</p>
        </Link>
        <Link to={`/documents/73`}>
          <p>Положение о правах, обязанностях и ответственности обучающихся СУ</p>
        </Link>
      </div>
      <div>
        ...
        <Link to={`/documents/59`}>
          <p>ДИ коменданта хозяйственной службы учебных корпусов</p>
        </Link>
        <Link to={`/documents/60`}>
          <p>ДИ проректора по гос.языку и науки</p>
        </Link>
        <Link to={`/documents/61`}>
          <p>ДИ проректора по учебно-воспитательной работе</p>
        </Link>
        <Link to={`/documents/62`}>
          <p>ДИ ректора</p>
        </Link>
        <Link to={`/documents/63`}>
          <p>ДИ руководителя HR и делопроизводства</p>
        </Link>
        <Link to={`/documents/64`}>
          <p>ДИ руководителя департамента развития и качества образования</p>
        </Link>
        <Link to={`/documents/65`}>
          <p>ДИ руководителя управления делами</p>
        </Link>
        <Link to={`/documents/66`}>
          <p>ДИ специалиста по МСК департамента развития и качества образования</p>
        </Link>
        <Link to={`/documents/67`}>
          <p>ДИ ученого секретаря Ученого совета</p>
        </Link>
        <Link to={`/documents/68`}>
          <p>Должностная инструкция главного бухгалтера СУ</p>
        </Link>
        <Link to={`/documents/69`}>
          <p>Должностная инструкция директора колледжа</p>
        </Link>
      </div>
      <div>
        <h1>Отчеты</h1>
